...
function update(item3,index){
groceryList[index] = item3
console.log("item was updated" + item3)
return item3
}
...
function h(){
  console.log("the grocery list has" + groceryList.length+ "items")
}
//////////////////////////////////////////////////////////////////////
